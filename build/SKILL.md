...
prior commit.
   ...
   If any heading is wrong, the validator counts ZERO features and fails the
   whole plan, even though the per-feature fields below may all be present.
   Fix every drifted heading before continuing.
