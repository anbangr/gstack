...
const MODULE_TEST_OWNERS: Record<string, string[]> = {
  ...
  "feature-review-cache.ts": ["feature-review-cache.test.ts"],
  "feature-review-metrics.ts": ["feature-review-metrics.test.ts"],
  "feature-review-prompt.ts": ["feature-review-prompt.test.ts"],
  "feature-review.ts": ["feature-review.test.ts"],
  "feature-verifier.ts": ["feature-verifier-pre-merge.test.ts"],
  "feature-verifier-metrics.ts": ["feature-verifier-metrics.test.ts"],
  ...
  "plan-review-loop.ts": [
    "plan-review-history-jsonl.test.ts",
    "convergence-jsonl.test.ts",
    "adaptive-cap-set-aware.test.ts",
    "plan-reviewer-triage-tty.test.ts",
    "plan-reviewer-triage-non-tty.test.ts",
    "plan-reviewer-loop.test.ts",
    "integration/loop-converge-bundle-1.test.ts",
    "integration/loop-bail-no-progress.test.ts",
    "integration/loop-synth-disputes.test.ts",
  ],
  "plan-reviewer.ts": [
    "cli.test.ts",
  ...
  "spec-archive-discovery.ts": ["spec-archive-discovery.test.ts"],
  "stall-watchdog.ts": [
