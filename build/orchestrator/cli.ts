...
export function buildCodexReviewBody(
  ...
  return [
    ...
    "",
    phase.kind !== "code"
      ? `0. This is a ${phase.kind} phase — review the non-code deliverables (written artifacts, results, research docs, or manual preparation) against the phase description. Do NOT run tests or check code coverage.`
      : "",
